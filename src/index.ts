...
export function deleteStore(id: string): Result<Store, string> {
    ...
    try {
        ...
        return Result.Err<Store, string>(
            "An error occurred - cannot delete discount code(s) associated with this store",
        );
    }
...
$query;
export function getStoreDiscountCodes(storeId: string): Result<Vec<DiscountCode>, string> {
